import {
  chacha20poly1305
} from "./chunk-FBT7ZNJW.js";
import {
  __publicField
} from "./chunk-QWN5BXRD.js";

// node_modules/@rialo/ts-cdk/dist/index.mjs
...
var init_base = __esm({
  "node_modules/@scure/base/index.js"() {
    ...
    createBase58check = (sha2563) => chain(checksum(4, (data) => sha2563(sha2563(data))), base58);
...
var CryptoErrorCode = ((CryptoErrorCode2) => {
...
var CryptoError = class _CryptoError extends Error {
  ...
  static invalidMnemonic(reason) {
    ...
    return new _CryptoError("INVALID_MNEMONIC", message);
  }
  static keyDerivationFailed(path, cause) {
    return new _CryptoError(
      "KEY_DERIVATION_FAILED",
      `Failed to derive key at path: ${path}`,
      { path, cause: cause == null ? void 0 : cause.message }
    );
  }
...
var subtle = () => {
  var _a5;
  return ((_a5 = cr()) == null ? void 0 : _a5.subtle) ?? err("crypto.subtle must be defined, consider polyfill");
};
...
var Point = (_a2 = class {
  ...
  static fromAffine(p) {
    return new _a2(p.x, p.y, 1n, M(p.x * p.y));
  }
  ...
  static fromBytes(hex2, zip215 = false) {
    ...
    if (isLastByteOdd !== isXOdd)
      x = M(-x);
    return new _a2(x, y, 1n, M(x * y));
  }
  static fromHex(hex2, zip215) {
    return _a2.fromBytes(hexToBytes(hex2), zip215);
  }
  get x() {
  ...
  negate() {
    return new _a2(M(-this.X), this.Y, this.Z, M(-this.T));
  }
  ...
  static findProgramAddress(seeds, programId) {
    ...
    for (let bump = MAX_BUMP_SEED; bump >= 0; bump--) {
      try {
        ...
        if (e instanceof CryptoError && e.code === "INVALID_SEEDS_ON_CURVE") {
          continue;
        }
        throw e;
      }
...
var sha2562 = createHasher2(
  () => new _SHA2562(),
  oidNist2(1)
);
var sha5122 = createHasher2(
  () => new _SHA5122(),
  oidNist2(3)
);
init_base();
...
var RialoErrorType = ((RialoErrorType2) => {
...
var RialoError = class _RialoError extends Error {
  ...
  static io(message, cause) {
    return new _RialoError("IO", `I/O error: ${message}`, cause);
  }
  /**
  ...
  static wallet(message) {
    return new _RialoError("WALLET", `Wallet error: ${message}`);
  }
  /**
   * Creates a configuration error.
   */
  static config(message) {
    return new _RialoError("CONFIG", `Config error: ${message}`);
  }
  /**
  ...
  static json(message, cause) {
    return new _RialoError("JSON", `JSON error: ${message}`, cause);
  }
  /**
   * Creates a BIP32 error.
   */
  static bip32(message) {
    return new _RialoError("BIP32", `BIP32 error: ${message}`);
  }
  /**
...
var EncryptionErrorCode = ((EncryptionErrorCode2) => {
...
var EncryptionError = class _EncryptionError extends Error {
  ...
  static invalidInput(message) {
    return new _EncryptionError("INVALID_INPUT", message);
  }
  static invalidThresholdKey(cause) {
    return new _EncryptionError(
      "INVALID_THRESHOLD_KEY",
...
var RexValueVariant = ((RexValueVariant2) => {
...
var RexValue = class _RexValue {
  ...
  static encrypted(ciphertext) {
    return new _RexValue(1, ciphertext);
  }
  /**
...
function edwards(params, extraOpts = {}) {
  ...
  const _Point2 = class _Point2 {
    ...
    static fromAffine(p) {
      ...
      acoord("x", x);
      acoord("y", y);
      return new _Point2(x, y, _1n4, modP(x * y));
    }
    ...
    static fromBytes(bytes2, zip215 = false) {
      ...
      if (isLastByteOdd !== isXOdd)
        x = modP(-x);
      return _Point2.fromAffine({ x, y });
    }
    static fromHex(hex2, zip215 = false) {
      return _Point2.fromBytes(hexToBytes2(hex2), zip215);
    }
    get x() {
      return this.toAffine().x;
    }
    ...
    negate() {
      return new _Point2(modP(-this.X), this.Y, this.Z, modP(-this.T));
    }
    ...
    multiply(scalar) {
      ...
      const { p, f } = wnaf.cached(this, scalar, (p2) => normalizeZ(_Point2, p2));
      return normalizeZ(_Point2, [p, f])[0];
    }
    ...
    multiplyUnsafe(scalar, acc = _Point2.ZERO) {
      ...
      if (this.is0() || scalar === _1n4)
        return this;
      return wnaf.unsafe(this, scalar, (p) => normalizeZ(_Point2, p), acc);
    }
  ...
  __publicField(_Point2, "BASE", new _Point2(CURVE.Gx, CURVE.Gy, _1n4, modP(CURVE.Gx * CURVE.Gy)));
  // zero / infinity / identity point
  __publicField(_Point2, "ZERO", new _Point2(_0n4, _1n4, _1n4, _0n4));
  // 0, 1, 1, 0
  // math field
  __publicField(_Point2, "Fp", Fp2);
  // scalar field
  __publicField(_Point2, "Fn", Fn2);
  let Point2 = _Point2;
...
var _a3;
var PrimeEdwardsPoint = (_a3 = class {
  constructor(ep) {
...
}, __publicField(_a3, "BASE"), __publicField(_a3, "ZERO"), __publicField(_a3, "Fp"), __publicField(_a3, "Fn"), _a3);
var _0n5 = BigInt(0);
var _1n5 = BigInt(1);
var _2n3 = BigInt(2);
var _5n2 = BigInt(5);
...
var ed25519_Point = edwards(ed25519_CURVE2, { uvRatio: uvRatio2 });
...
var _a4;
var _RistrettoPoint = (_a4 = class extends PrimeEdwardsPoint {
  constructor(ep) {
    super(ep);
  }
  static fromAffine(ap) {
    return new _a4(ed25519_Point.fromAffine(ap));
  }
  assertSame(other) {
    if (!(other instanceof _a4))
  ...
  static fromBytes(bytes2) {
    ...
    return new _a4(new ed25519_Point(x, y, _1n5, t));
  }
  /**
   ...
   */
  static fromHex(hex2) {
    return _a4.fromBytes(hexToBytes2(hex2));
  }
  /**
  ...
  is0() {
    return this.equals(_a4.ZERO);
  }
}, // Do NOT change syntax: the following gymnastics is done,
// because typescript strips comments, which makes bundlers disable tree-shaking.
// prettier-ignore
__publicField(_a4, "BASE", (() => new _a4(ed25519_Point.BASE))()), // prettier-ignore
__publicField(_a4, "ZERO", (() => new _a4(ed25519_Point.ZERO))()), // prettier-ignore
__publicField(_a4, "Fp", /* @__PURE__ */ (() => Fp)()), // prettier-ignore
__publicField(_a4, "Fn", /* @__PURE__ */ (() => Fn)()), _a4);
...
var DKG_KDF_SALT = new TextEncoder().encode(
  "RIALO_DKG_THRESHOLD_V1"
);
var DKG_ACL_AAD_DOMAIN = new TextEncoder().encode(
  "RIALO_DKG_ACL_V1"
  // exactly 16 bytes
);
...
var RpcError = class _RpcError extends Error {
  ...
  static fromRpcCode(rpcCode, message, details) {
    ...
    const code = codeMap[rpcCode] || "INTERNAL_ERROR";
...
var QueryRpcClient = class extends BaseRpcClient {
  ...
  async getBlock(blockHeight, config) {
    ...
    if (config == null ? void 0 : config.transactionDetails) {
...
var TransactionRpcClient = class extends BaseRpcClient {
  ...
  async sendTransaction(transaction, options) {
    ...
    const config = {
      encoding: "base64",
      skipPreflight: (options == null ? void 0 : options.skipPreflight) ?? false,
      maxRetries: (options == null ? void 0 : options.maxRetries) ?? 5
    };
  ...
  async confirmTransaction(signature, options) {
    const maxRetries = (options == null ? void 0 : options.maxRetries) ?? DEFAULT_MAX_RETRIES;
    const retryDelayMs = (options == null ? void 0 : options.retryDelayMs) ?? DEFAULT_RETRY_DELAY_MS;
    for (let attempt = 0; attempt < maxRetries; attempt++) {
      ...
      try {
        ...
        if (error instanceof RpcError && error.code === "TRANSACTION_REJECTED") {
          throw error;
        }
      }
    }
  ...
  async sendAndConfirmTransaction(transaction, options) {
    const signature = await this.sendTransaction(transaction, {
      skipPreflight: options == null ? void 0 : options.skipPreflight,
      maxRetries: options == null ? void 0 : options.maxRetries
    });
    return await this.confirmTransaction(signature, {
      maxRetries: options == null ? void 0 : options.confirmMaxRetries,
      retryDelayMs: options == null ? void 0 : options.confirmRetryDelayMs
    });
  }
  /**
  ...
  async getTransaction(signature) {
    ...
    return {
      blockHeight: BigInt(result.block_height ?? 0),
      err: result.err ?? ((_a5 = result.meta) == null ? void 0 : _a5.err) ?? void 0
    };
  }
  /**
...
var RialoClient = class extends RpcClient {
  constructor(transport, chain2) {
    ...
    __publicField(this, "transactionClient");
    __publicField(this, "transport");
...
var HttpTransport = class {
  ...
  async handleHttpError(response, requestDetails, attempt) {
    ...
    return new RpcError("NETWORK_ERROR", message, baseDetails, isRetryable);
  }
  /**
...
function serializeField(fieldName, fieldType, options) {
  ...
  try {
      ...
      if (typeof fieldType === "string") {
        ...
        if (fieldType.elementType === "u8") {
          if (fieldType instanceof FixedArrayKind) {
            return (options == null ? void 0 : options.unchecked) ? BinaryWriter.uint8ArrayFixed : (obj, writer) => {
        ...
        return (obj, writer) => {
          var _a5;
          if (!(options == null ? void 0 : options.unchecked) && !checkClazzesCompatible(obj.constructor, fieldType)) {
            throw new BorshError(`Field value of field ${fieldName} is not instance of expected Class ${(_a5 = getSuperMostClass(fieldType)) == null ? void 0 : _a5.name}. Got: ${obj.constructor.name}`);
          }
    ...
    if (!(options == null ? void 0 : options.unchecked)) {
      return (obj, writer) => {
        if (obj == null && fieldType instanceof OptionKind === false) {
          throw new BorshError(`Trying to serialize a null value to field "${fieldName}" which is not allowed since the field is not decorated with "option(...)" but "${typeof fieldType === "function" && (fieldType == null ? void 0 : fieldType.name) ? fieldType == null ? void 0 : fieldType.name : fieldType}". Most likely you have forgotten to assign this value before serializing`);
        }
...
function serializeStruct(ctor, allowCustomSerializer = true) {
  ...
  while (true) {
    ...
    } else if (once && !((_a5 = getDependencies(ctor, i)) == null ? void 0 : _a5.length)) {
      return handle;
    }
    i++;
...
function deserializeStruct(targetClazz, fromBuffer) {
  ...
  return (reader, options) => {
    ...
    if (!(options == null ? void 0 : options.unchecked) && !(options == null ? void 0 : options.object) && !checkClazzesCompatible(result.constructor, targetClazz)) {
      throw new BorshError(`Deserialization of ${(targetClazz == null ? void 0 : targetClazz.name) || targetClazz} yielded another Class: ${(_a5 = result.constructor) == null ? void 0 : _a5.name} which are not compatible`);
    }
    return result;
  };
}
...
var createDeserializeStructHandle = (currClazz, offset, fromBuffer) => {
  ...
  let endHandle = (result, reader, options) => {
    ...
    return Object.assign((options == null ? void 0 : options.construct) ? new currClazz() : Object.create(currClazz.prototype), result);
  };
...
var setDependencyToProtoType = (ctor, offset) => {
  ...
  while (((_a5 = proto.prototype) == null ? void 0 : _a5.constructor) != void 0) {
...
var getSubMostSchema = (ctor) => {
  ...
  for (var i = 0; i < MAX_PROTOTYPE_SEARCH; i++) {
    ...
    if (!curr && last && !((_a5 = getDependencies(ctor, i)) == null ? void 0 : _a5.length)) {
      return last;
    }
    last = curr;
  }
...
var AccountMetaTable = class {
  constructor() {
    ...
    __publicField(this, "accountOrder", []);
    __publicField(this, "payerKey", null);
  }
  /**
...
var TransactionErrorCode = ((TransactionErrorCode2) => {
...
var Message = class _Message {
  constructor(header, accountKeys, validFrom, configHashPrefix, occ, instructions) {
    ...
    __publicField(this, "accountKeys");
...
var RialoKeyring = class extends Keyring {
  ...
  activeKeypair() {
    ...
    if (!kp) {
      throw new RialoError("WALLET", "Active keypair does not exist");
    }
    return kp;
  }
  sign(message) {
...
var InMemoryKeyringProvider = class extends KeyringProvider {
  constructor() {
    super(...arguments);
    __publicField(this, "keyrings", /* @__PURE__ */ new Map());
  }
  getStored(name) {
    const stored = this.keyrings.get(name);
    if (!stored) {
      throw new RialoError("WALLET", `Keyring not found: ${name}`);
    }
    return stored;
  }
  checkPassword(stored, password) {
    if (stored.password !== password) {
      throw new RialoError("PASSWORD", "Invalid password");
    }
  }
  buildKeyring(stored) {
  ...
  async create(name, password) {
    if (this.keyrings.has(name)) {
      throw new RialoError("WALLET", `Keyring already exists: ${name}`);
    }
  ...
  async recoverFromMnemonic(name, mnemonicPhrase, password) {
    ...
    if (!Mnemonic.isValid(mnemonicPhrase)) {
      throw new RialoError("INVALID_INPUT", "Invalid BIP39 mnemonic phrase");
    }
  ...
  async getPublicKey(name) {
    ...
    if (!kp) throw new RialoError("WALLET", `Keyring ${name} has no keypair at index 0`);
    return kp.publicKey;
  }
...
init_base();
var DeploymentErrorCode = ((DeploymentErrorCode2) => {
...
var RiscVLoaderInstruction = ((RiscVLoaderInstruction2) => {
...
var ProgramDeployment = class {
  constructor(options) {
    __publicField(this, "programData");
    __publicField(this, "programKeypair");
    __publicField(this, "chunkSize");
    __publicField(this, "maxRetries");
    __publicField(this, "retryBaseDelayMs");
    __publicField(this, "retryMaxDelayMs");
    __publicField(this, "confirmationBatchSize");
    ...
    const chunkSize = ((_a5 = options.config) == null ? void 0 : _a5.chunkSize) ?? DEFAULT_CHUNK_SIZE;
    if (chunkSize <= 0) {
      throw DeploymentError.invalidChunkSize(chunkSize);
    }
    this.chunkSize = chunkSize;
    this.maxRetries = ((_b = options.config) == null ? void 0 : _b.maxRetries) ?? DEFAULT_MAX_RETRIES2;
    this.retryBaseDelayMs = ((_c = options.config) == null ? void 0 : _c.retryBaseDelayMs) ?? DEFAULT_RETRY_BASE_DELAY_MS;
    this.retryMaxDelayMs = ((_d2 = options.config) == null ? void 0 : _d2.retryMaxDelayMs) ?? DEFAULT_RETRY_MAX_DELAY_MS;
    this.confirmationBatchSize = ((_e = options.config) == null ? void 0 : _e.confirmationBatchSize) ?? DEFAULT_CONFIRMATION_BATCH_SIZE;
  }
  /**
  ...
  toDeploymentError(e) {
    ...
    if (e instanceof RpcError) {
      ...
      switch (e.code) {
        case "TRANSACTION_CONFIRMATION_TIMEOUT":
...
export {
  ...
  createAccount,
  createBorshInstruction,
  createRialoClient,
  deployInstruction,
  deserialize,
  deserializeBorsh,
  deserializeCompactU162 as deserializeCompactU16,
  deserializeStrict,
  encodeBorshData,
  encryptForRex,
  encryptSecret,
  encryptSecretBytes,
  encryptSecretBytesWithEpoch,
  field,
  fixedArray,
  fromBase64,
...
@rialo/ts-cdk/dist/index.mjs:
  ...
  *)
*/
//# sourceMappingURL=@rialo_ts-cdk.js.map
