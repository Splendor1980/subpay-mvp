...
export default function App() {
  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "24px 16px" }}>
      ...
      {!isConnected && (
        <section style={{ textAlign: "center", padding: "80px 0" }}>
          ...
          <button onClick={() => setView("create")} style={{
            ...
            background: "#4361ee", color: "#fff", fontSize: 16, cursor: "pointer",
          }}>
            Try Demo
          </button>
        </section>
      ...
      {isConnected && (
        <>
          <nav style={{ display: "flex", gap: 8, marginBottom: 24, borderBottom: "1px solid #e0e0e0", paddingBottom: 8 }}>
            <button onClick={() => setView("create")} style={{
              padding: "8px 16px", border: "none",
              background: view === "create" ? "#4361ee" : "transparent",
              color: view === "create" ? "#fff" : "#333", borderRadius: 6, cursor: "pointer",
            }}>
              + New Subscription
            </button>
            <button onClick={() => setView("dashboard")} style={{
              ...
              color: view === "dashboard" ? "#fff" : "#333", borderRadius: 6, cursor: "pointer",
            }}>
              My Subscriptions
            </button>
          </nav>
